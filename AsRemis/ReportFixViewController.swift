...
class ReportFixViewController: UIViewController,UIGestureRecognizerDelegate{
    ...
    func sendAlert(){
        let alertController = UIAlertController(title: "O correio não foi enviado", message: "Não foi possível enviar o e-mail, tente mais tarde", preferredStyle: UIAlertControllerStyle.alert)
