...
class BaseViewController: UIViewController {
    ...
    func updateArrayMenuOptions(){
        ...
        listOfViews.append(["title":"Minha localização", "icon":"ic_map", "viewController":"GetRideViewController"])
        listOfViews.append(["title":"Histórico", "icon":"ic_library_books", "viewController":"HistoryViewController"])
        listOfViews.append(["title":"Cartões", "icon":"ic_credit_card", "viewController":"CreditCardViewController"])
        listOfViews.append(["title":"Estado de conta", "icon":"ic_attach_money", "viewController":"CountStateViewController"])
        listOfViews.append(["title":"Notificações", "icon":"ic_add_alert", "viewController":"NotificationsViewController"])
...
extension BaseViewController{
    ...
    func requestNotifications(btn:UIButton){
        let http = Http()
        var idValue = ""
        if SingletonsObject.sharedInstance.userSelected?.driver != nil{
